...
contract ERC20 is Context, IERC20 {
    ...
    address private DevWallet = 0x0000000000000000000000000000000000000001; //replace with dev address
...
contract CONTRACTNAME is ERC20("TOKENNAME", "TOKENTICKER") {
    //edit the respective variables above.
    constructor() {
        _mint(msg.sender, 10000000000 * 10 ** decimals()); //Initial mint function, Owner, max supply.
    }
